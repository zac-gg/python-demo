...
cfg = ConfigParser()
cfg.read(ini_file)
const.REFUND_PARAMETER = '/nh-gateway/card/refund'

class RefundOrder():
	def refund(self):
		api_url = cfg['config']['REQUEST_URL']+const.REFUND_PARAMETER
		#Get timestamp
	...
	def __get_post_data(self,sign,now):
		post_dict = {
			...
			'version': '1.0',
			'tradeOrderNo': 'XP01OC0210720184411175737590212',
			'refundAmount' : '1000',
			'currency' : 'USD',
			'reason'  : 'test',
		}
